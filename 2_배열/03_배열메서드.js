...
// 끝 인덱스를 안 적으면 시작번호부터 끝가지 전부 복사
sliceFoods = foodList.slice(2); // 끝까지 명시 안함
console.log(`잘린음식 : ${sliceFoods}, 원본음식 : ${foodList}`);
...
// reverse는 인덱스번호 기준으로 역순 나열합니다. 원본배열아 바뀝니다.
console.log("======================");
...
// concat() : 배열 2개를 연결 (배열1 길이 + 배열2 길이 = 결과리스트길이)
console.log("============================");
var arr1 = [10, 20, 30];
