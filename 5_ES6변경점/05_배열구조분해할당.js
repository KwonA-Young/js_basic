...
// 일반 확장을 하려고 하는 경우, 
// 첫번째로 이중배열 처리가 되고
// 두번째는 얕은 복사가 일어나는 문제가 있다.
foods[0] = '크로켓';
console.log(`foods : ${foods}, newFoods : ${newFoods}`);

// 깊은복사를 이용해 배열 확장 및 깊은 복사 처리가 가능하다
// 배열 복사가 다음과 같이 된다.
// ['돈까스', '감자탕', '내장탕', '보쌈', '초밥', '햄버거']
const advFodds = [...foods, '초밥', '햄버거'];
console.log(`advFoods의 이중배열 여부 : ${advFodds[0]}`);

foods[1] = '치킨마요덮밥';
// 스프레드 문법이 적용된 복사는 깊은 복사입니다.
console.log(`foods : ${foods}, advFoods : ${advFodds}`);
